...
@php
    function isLogin() {
        ...
        $loginUri = Route('login');
        return $current==$loginUri;
    }
@endphp
                ...
                <div class="reg-form-container">
                    ...
                    <div class="reg-options" >
                        <ul class="nav nav-tabs">
                            <li @if(!isLogin()) class="active"; @endif ><a href="#register" data-toggle="tab">Register</a></li>
                            <li @if(isLogin()) class="active"; @endif ><a href="#login" data-toggle="tab">Login</a></li>
                        </ul><!--Tabs End-->
                    </div>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane @if(!isLogin()) active @endif " id="register" style="text-align: center">
                            <h3>Register Now !!!</h3>
                            ...
                            <form name="registration_form" id='registration_form' class="form-inline">
                                ...
                                <div class="form-group gender" style="color: #000000">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-xs-12">
                                        <label for="email" class="sr-only">Email</label>
                                        <input id="phone" class="form-control input-group-lg" type="text" name="PhoneNo" title="Enter phone no" placeholder="Phone number"/>
                                    </div>
                                    <div class="form-group col-xs-12">
                                        <label for="email" class="sr-only">Occupation</label>
                                        <input id="occ" class="form-control input-group-lg" type="text" name="Occupation" title="Enter occupation" placeholder="Occupation"/>
                                    </div>
                        ...
                        <!--Login-->
                        <div class="tab-pane @if(isLogin()) active @endif " id="login" style="text-align: center">
                            <h3>Login</h3>
                            ...
                            <p><a href="#" style="font-size: 14px">Forgot Password?</a></p>
