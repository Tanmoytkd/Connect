						...
						<div class="row">
							<div class="col-lg-3">
								<div class="main-left-sidebar">
                                    <?php include "Profile/leftInfo.blade.php";?>
											...
											<div class="gallery_pf">
												<div class="row">
													<div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                                        ...
                                                        <?php include "Profile/portfolio.blade.php";?>
							...
							<div class="col-lg-3">
								<div class="right-sidebar">
									<div class="message-btn">
										<a href="#" title=""><i class="fa fa-envelope"></i> Review</a>
									</div>
...
<!-- Mirrored from gamboldesigns.net/Demo/HTML/user-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 26 Jul 2018 19:01:57 GMT -->
</html>